      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
              ...
              <TabsContent value="generate" className="mt-6">
                ...
                <div className="mt-4 p-4 bg-muted/30 rounded-lg">
                  ...
                  <div className="flex flex-wrap gap-2 text-sm">
                    {['Product Strategy', 'User Research', 'Analytics', 'Roadmapping', 'Stakeholder Management', 'A/B Testing'].map(topic => <span key={topic} className="px-2 py-1 bg-background rounded border text-muted-foreground">
                        {topic}
                      </span>)}
                  </div>
                </div>
            ...
            {/* Question List */}
            <QuestionList questions={quizState.questions} selectedQuestion={quizState.selectedQuestion} onQuestionSelect={handleQuestionSelect} />
          </div>
